# WeBuyCars · Business Analyst Team
...
The thing BAs use least but would benefit from most is using Claude as a **thinking partner** — not just a drafting tool. Try these approaches to get more strategic value out of every session.

> **Remember:** Claude won't replace what you do as a BA — it handles the repetitive formatting and drafting so you can focus on the thinking and the stakeholder work. The more you use it, the better you will get at prompting it.
